...
--
--table structre for table consultants
--
CREATE TABLE `consultants` (
  ...
  `experience` int(3) DEFAULT NULL, -- Number of years of experience
  `bio` TEXT DEFAULT NULL, -- Biography field for consultants
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `consultants` (`id`, `first_name`, `last_name`, `email`, `password`, `age`, `phone_number`, `field`, `experience`) VALUES
(1, 'John', 'Doe', 'john.doe@example.com', '$2y$10$someHashedPassword', 35, '0501234567', 'Software Engineering', 10),
(2, 'Jane', 'Smith', 'jane.smith@example.com', '$2y$10$someOtherHashedPassword', 30, '0509876543', 'Data Science', 8);
